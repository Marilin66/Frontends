...
class AdminHopitalChangePasswordContent extends ConsumerStatefulWidget {
  const AdminHopitalChangePasswordContent({super.key});

  @override
  ConsumerState<AdminHopitalChangePasswordContent> createState() => _AdminHopitalChangePasswordContentState();
}

class _AdminHopitalChangePasswordContentState extends ConsumerState<AdminHopitalChangePasswordContent> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.lock_reset, size: 64, color: AppColors.adminHopital),
              ),
