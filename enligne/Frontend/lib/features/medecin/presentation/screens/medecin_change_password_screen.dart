...
class MedecinChangePasswordContent extends ConsumerStatefulWidget {
  const MedecinChangePasswordContent({super.key});

  @override
  ConsumerState<MedecinChangePasswordContent> createState() => _MedecinChangePasswordContentState();
}

class _MedecinChangePasswordContentState extends ConsumerState<MedecinChangePasswordContent> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.lock_reset, size: 64, color: AppColors.medecin),
              ),
