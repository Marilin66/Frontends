...
class MedecinAboutContent extends ConsumerWidget {
  const MedecinAboutContent({super.key});
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildFeatureItem(Icons.video_call, 'Téléconsultations'),
                  _buildFeatureItem(Icons.chat, 'Messagerie sécurisée'),
                  _buildFeatureItem(Icons.description, 'Résultats médicaux'),
                  _buildFeatureItem(Icons.local_hospital, 'Réseau d\'hôpitaux'),
                ],
              ),
            ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(icon, color: AppColors.medecin, size: 16),
          ),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(icon, color: AppColors.medecin, size: 20),
            ),
            const SizedBox(width: 12),
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: GoogleFonts.poppins(
                      fontSize: 14,
                      color: url != null ? AppColors.medecin : AppColors.textPrimary,
