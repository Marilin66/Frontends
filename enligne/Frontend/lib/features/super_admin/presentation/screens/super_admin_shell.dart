...
class SuperAdminShell extends ConsumerWidget {
  ...
  int _calculateIndex(String location) {
    ...
    if (location.startsWith('/super-admin/stats')) return 3;
    if (location.startsWith('/super-admin/messagerie')) return 4;
    if (location.startsWith('/super-admin/settings')) return 5;
    return 0;
  }
  ...
  void _onTap(int index, BuildContext context) {
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        context.go('/super-admin/hopitaux');
        break;
      case 2:
        context.go('/super-admin/users');
        break;
      case 3:
        context.go('/super-admin/stats');
        break;
      case 4:
        context.go('/super-admin/messagerie');
        break;
      case 5:
    ...
    return Stack(
      children: [
        ResponsiveShellLayout(
          ...
          indicatorColor: AppColors.superAdmin.withOpacity(0.15),
          destinations: const [
