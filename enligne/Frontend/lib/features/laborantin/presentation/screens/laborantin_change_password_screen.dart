...
class LaborantinChangePasswordScreen extends ConsumerStatefulWidget {
  const LaborantinChangePasswordScreen({super.key});

  @override
  ConsumerState<LaborantinChangePasswordScreen> createState() => _LaborantinChangePasswordScreenState();
}

class _LaborantinChangePasswordScreenState extends ConsumerState<LaborantinChangePasswordScreen> {
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.lock_reset, size: 64, color: AppColors.laborantin),
              ),
