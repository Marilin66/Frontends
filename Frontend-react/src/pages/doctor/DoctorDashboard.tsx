...
import {
  ...
  Stethoscope, RefreshCw, AlertCircle, ClipboardList
} from 'lucide-react';
...
export default function DoctorDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {apt.pre_enregistrement && (
                      <button
                        ...
                        className="mt-0.5 flex items-center gap-1 text-xs text-teal-600 font-medium hover:text-teal-700 transition"
                      >
                ...
                <div key={apt.id} className="flex items-center gap-4 px-6 py-3.5 hover:bg-slate-50 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {apt.pre_enregistrement && (
                      <button
                        onClick={() => setShowIntake(apt.pre_enregistrement)}
                        className="mt-1 flex items-center gap-1 text-xs text-teal-600 font-medium hover:text-teal-700 transition"
                      >
                        <ClipboardList className="w-3 h-3" />
      ...
      {showIntake && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={() => setShowIntake(null)}>
          <motion.div
          ...
          >
            <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="text-base font-bold text-slate-900">Fiche pré-consultation</h3>
                  <p className="text-xs text-teal-600 font-medium">Transmise par le patient</p>
                </div>
              </div>
            ...
            <div className="p-6 space-y-4">
              {[
                { icon: AlertCircle, label: 'Symptômes principaux',        key: 'symptomes_principaux',  color: 'text-red-500',    bg: 'bg-red-50' },
                { icon: Calendar,    label: 'Début des symptômes',         key: 'debut_symptomes',       color: 'text-orange-500', bg: 'bg-orange-50' },
                { icon: FileText,    label: 'Traitements en cours',        key: 'traitements_en_cours',  color: 'text-blue-500',   bg: 'bg-blue-50' },
                { icon: FileText,    label: 'Observations complémentaires',key: 'observations',          color: 'text-purple-500', bg: 'bg-purple-50' },
      ...
      {/* ── Modal erreur ─────────────────────────────────────────────── */}
      {errorModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={() => setErrorModal('')}>
          <motion.div
